...
/**
 * Seeds the default roles and permissions into a freshly provisioned tenant.
 *
 * Runs inside the tenant context (tenancy()->initialized === true).
 * Designed to be idempotent — safe to re-run after adding new permissions.
 */
